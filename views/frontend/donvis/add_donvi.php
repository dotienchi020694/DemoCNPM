	...
	<body>
		...
		<form class="panel panel-default panel-main-body" method="POST" action="">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Thêm đơn vị</h3>
			</div>
			<div class="panel-body">
				<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">Tên đơn vị</label>
				    <div class="col-md-10">
				        <input type="text" name="ten" class="form-control" id="inputEmail3" placeholder="Tên đơn vị">
				    </div>
				</div>
				...
				<div class="button-form">
					<a href="index.php?controller=donvi"><button type="button" class="btn btn-primary">Quay lại</button></a>
					<input class="btn btn-success" type="submit" name="submit" id="create-btn" value="Tạo đơn vị">
				</div>
			</div>
		</form>
	</body>
