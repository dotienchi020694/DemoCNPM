<html>
	...
	<body>
		...
		<ol class="breadcrumb">
		    ...
		    <li>Học vị</li>
		    <li class="active">Thêm học vị</li>
		</ol>

		<form class="panel panel-default panel-main-body" method="POST" action="">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Thêm học vị</h3>
			</div>
			<div class="panel-body">
				<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">Tên học vị</label>
				    <div class="col-md-10">
				        <input type="text" name="newhvten" class="form-control" id="inputEmail3" placeholder="Tên học vị">
				    </div>
				</div>
				<div class="form-group">
				  	<label for="comment">Mô tả</label>
				  	<textarea class="form-control" name="newhvmota" rows="5" id="comment"></textarea>
				</div>
				<div class="button-form">
					<a href="index.php?controller=hocvi"><button type="button" class="btn btn-primary">Quay lại</button></a>
					<input class="btn btn-success" type="submit" name="submit" id="create-btn" value="Tạo học vị">
				</div>
			</div>
		</form>
	</body>
