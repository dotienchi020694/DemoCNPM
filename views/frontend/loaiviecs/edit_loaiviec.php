	...
	<body>
		...
		<ol class="breadcrumb">
		    ...
		    <li>Quản lý quy đổi giờ chuân</li>
                    <li>Loại việc</li>
		    <li class="active">Chỉnh sửa loại việc </li>
		</ol>

		<form class="panel panel-default panel-main-body" method="POST" action="">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Chỉnh sửa loại việc <?php echo $result["lv_ten"]; ?></h3>
			</div>
			<div class="panel-body">
				<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">Tên loại việc</label>
				    <div class="col-md-10">
				        <?php echo '<input type="text" name="lv_ten" class="form-control" id="inputEmail3" placeholder="Tên bộ môn" value="'. $result["lv_ten"] . '">'; ?>
				    </div>
				</div>
				<div class="form-group">
				  	<label for="comment">Mô tả</label>
				  	<textarea class="form-control" name="lv_mota" rows="5" id="comment"><?php echo $result["lv_mota"]; ?></textarea>
				</div>
				<div class="button-form">
					...
					<button id="update-btn" class="btn btn-success" type="submit" name="lv_id" value=<?php echo $_GET["lv_id"]; ?>>Cập nhật</button>
				</div>
			</div>
		</form>
	</body>
