<html>
	...
	<body>
		...
		<ol class="breadcrumb">
		    ...
		    <li>Bộ môn</li>
		    <li class="active">Chỉnh sửa bộ môn <?php echo $result["bm_ten"]; ?></li>
		</ol>

		<form class="panel panel-default panel-main-body" method="POST" action="">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Chỉnh sửa bộ môn <?php echo $result["bm_ten"]; ?></h3>
			</div>
			<div class="panel-body">
				<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">Tên bộ môn</label>
				    <div class="col-md-10">
				        <?php echo '<input type="text" name="editbmten" class="form-control" id="inputEmail3" placeholder="Tên bộ môn" value="'. $result["bm_ten"] . '">'; ?>
				    </div>
				</div>
				<div class="form-group">
				    <label for="inputEmail3" class="col-sm-2 control-label">Khoa</label>
				    <div class="col-md-10">
				        <select class="form-control" name="editkid">
				        <?php
				        	foreach($khoas as $row)  {
				        		echo "<option value=".$row["k_id"]. " "; if($row["k_ten"] == $result["k_ten"]) { echo "selected"; } echo ">" . $row["k_ten"] . "</option>";
				        	}
				        ?>
				    	</select>
				    </div>
				...
				<div class="form-group">
				  	...
				  	<textarea class="form-control" name="editbmmota" rows="5" id="comment"><?php echo $result["bm_mota"]; ?></textarea>
				</div>
				<div class="button-form">
					...
					<button id="update-btn" class="btn btn-success" type="submit" name="bm_id" value=<?php echo $_GET["bm_id"]; ?>>Cập nhật</button>
				</div>
			</div>
		</form>
	</body>
