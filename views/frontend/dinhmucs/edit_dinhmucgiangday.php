	...
	<body>
		...
		<?php require_once 'views/layouts/left_sidebar.php'; ?>
					...
					<ol class="breadcrumb">
					    ...
					    <li class="active">Chỉnh sửa định mức giờ giảng dạy</li>
					</ol>

					<form class="panel panel-default panel-main-body" method="POST" action="">
						<div class="panel-heading">
							<h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Chỉnh sửa định mức giờ giảng dạy</h3>
						</div>
						<div class="panel-body">
							<div class="form-group">
							    <label for="inputEmail3" class="col-sm-2 control-label ">Số giờ</label>
							    <div class="col-md-10">
                                                                <input type="text" class="form-control" id="inputEmail3" name="sogio" placeholder="Số giờ" value=<?php echo $result_dmgd["dmgd_sogio"];?>>
							    </div>
							</div>
							<div class="form-group">
                                                        <label for="comment">Mô tả</label>
                                                                <textarea class="form-control" name="mota" rows="5" id="comment"><?php echo $result_dmgd["dmgd_mota"]; ?></textarea>
                                                        </div>
							<div class="button-form">
								<button class="btn btn-primary"><a href="index.php?controller=dinhmuc_giangday">Quay lại</a></button>
								<button id="update-btn" class="btn btn-success" type="submit" name="dmgd_id" value=<?php echo $_GET["dmgd_id"]; ?>>Cập nhật</button>
							</div>
						</div>
					</form>	
	</body>
