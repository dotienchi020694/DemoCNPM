					...
					<ol class="breadcrumb">
						...
						<div class="panel-body">
							    ...
							    <div class="col-md-10">
                                                                ...
                                                                <?php
                                                                    foreach ($hocvis as $value) {
                                                                        echo "<option value=".$value["hv_id"].">".$value[hv_ten]."</option>";
                                                                    }
							...
							<div class="form-group">
							    ...
							    <div class="col-md-10">
							        <input type="text" class="form-control" id="inputEmail3" name="sogio" placeholder="Số giờ">
							    </div>
							</div>
							...
							<div class="button-form">
								<button class="btn btn-primary"><a href="index.php?controller=dinhmuc_giangday">Quay lại</a></button>
                                                                <input class="btn btn-success" name="submit" type="submit" id="create-btn" value="Tạo mới">
							</div>
						</div>
					</form>	
	</body>
